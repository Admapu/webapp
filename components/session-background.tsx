...
const BACKGROUNDS = ["/bg-new.jpg", "/bg-alt.jpg"] as const;
...
export function SessionBackground() {
  ...
  useEffect(() => {
    ...
    if (!storedBackground || !BACKGROUNDS.includes(storedBackground as (typeof BACKGROUNDS)[number]) || storedAuthState !== authState) {
